...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className = '', variant = 'primary', size = 'md', loading, children, disabled, ...props }, ref) => {
        ...
        const variants = {
            primary: 'gradient-bg text-white hover:opacity-90 focus:ring-accent-primary shadow-lg hover:shadow-xl hover:scale-[1.02]',
            secondary: 'bg-background-secondary text-foreground border border-border hover:bg-border hover:border-foreground-secondary',
